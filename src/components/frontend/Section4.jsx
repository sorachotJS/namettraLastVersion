...
import mockup1 from "../../assets/imgNamettra/monk-removebg-preview (1).png";
        ...
        <div className="clearfix row">
          ...
          <div className="mt-5 content-column col-lg-6 col-md-12 col-sm-12">
            <div className="inner-column">
              <img src={mockup1} alt="mockup1" width={400} height={400} />
            </div>
          </div>
          <div className="mt-10 content-column col-lg-6 col-md-12 col-sm-12">
            <div className="mt-5 text-center inner-column">
              ...
              <div className="mt-5">
                <Link to="/productmonk"  className="px-4 py-2 font-bold text-white bg-blue-500 border border-blue-700 rounded btn1 hover:bg-blue-700">
                  สั่งซื้อ
                </Link>
              </div>
              <div className="clearfix row">
